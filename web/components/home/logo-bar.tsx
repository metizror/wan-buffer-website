export function HomeLogoBar() {
  return (
    <section className="logo-bar">
      <div className="logo-bar-label">Trusted by businesses in 20+ nations</div>
      <div className="logo-marquee-outer">
        <div className="logo-fade-l" />
        <div className="logo-fade-r" />
      ...
      <div className="logo-bar-badges">
        <span className="lbb">
          <span className="lbb-dot red-d" />
          Odoo Official Partner
        </span>
        <span className="lbb">
          <span className="lbb-dot blue-d" />
      ...
      >
        <span className="why-logos-label">Trusted across</span>
        <span className="why-logo-pill">🇮🇳 India</span>
        <span className="why-logo-pill">🇺🇸 USA</span>
        <span className="why-logo-pill">🇨🇦 Canada</span>
        <span className="why-logo-pill">🇩🇪 Germany</span>
        <span className="why-logo-pill">🇦🇪 UAE</span>
        <span className="why-logo-pill">🇲🇦 Morocco</span>
      </div>
    </section>
  );
}
