...
export const metadata: Metadata = {
  ...
  description:
    "Browse Wan Buffer Odoo apps with screenshots, setup guides, and FAQs. Production-ready modules for Odoo 17, 18, and 19 with 90 days of free support on the Apps Store.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Production-ready Odoo modules with 90-day free support: browse our catalog and buy on the Odoo Apps Store.",
    siteName: "Wan Buffer",
  },
};
