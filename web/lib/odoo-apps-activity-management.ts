...
export const ACTIVITY_MANAGEMENT_APP: OdooApp = {
    ...
    introParagraphs: [
      ...
      "The module respects Odoo access rights, works with the apps you already installed, and ships with the same 90-day free support Wan Buffer provides across our Apps Store catalog.",
    ],
    ...
    features: [
      {
        title: "",
        body: "Centralized dashboard providing an overview of all activities.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f1.png`,
      },
      {
        title: "",
        body: "Activity Managers can monitor all activities across the organization.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f2.png`,
      },
      {
        title: "",
        body: "Dedicated \"All Activities\" menu for quick access.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f3.png`,
      },
      {
        title: "",
        body: "Well-organized structure for easy activity management.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f4.png`,
      },
      {
        title: "",
        body: "Filter activities by Today, Planned, Overdue or History.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f5.png`,
      },
      {
        title: "",
        body: "Ensures deadlines are met and responsibilities are tracked efficiently.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f6.png`,
      },
      {
        title: "",
        body: "Role-based visibility for Activity managers and user.",
        imageSrc: `${ACTIVITY_MANAGEMENT_FEATURES}/f7.png`,
      },
      {
        title: "",
        body: "Module-aware activity tracking: displays records based on installed modules.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Every purchase includes 90 days of free support from Wan Buffer. Email support@wanbuffer.com for setup help, bug reports, or customization questions.",
      },
    ],
