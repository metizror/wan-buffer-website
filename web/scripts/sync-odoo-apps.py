...
DEFAULT_HIGHLIGHTS = [
    ...
    {
        "title": "90 days of free Wan Buffer support",
        "body": "Every purchase includes 90 days of free support from our Odoo team for setup questions, fixes, and guidance.",
    },
    {
...
def parse_module(technical_name: str) -> dict:
    ...
    if len(intro_paragraphs) < 2:
        intro_paragraphs = [
            description,
            f"{name} is available on the Odoo Apps Store with 90 days of free support from Wan Buffer.",
        ]
    ...
    if len(faqs) < 2:
        faqs = [
            {"q": f"What does {name} do?", "a": description[:350]},
            {
                ...
                "a": "Yes. Wan Buffer includes 90 days of free support. Email support@wanbuffer.com for installation or customization help.",
            },
            {
